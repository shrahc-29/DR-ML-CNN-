...
# FREEZE EARLY LAYERS
for layer in model.get_layer("efficientnetb0").layers[:-30]:
...
fine_tune_callbacks = [
    ...
    ModelCheckpoint(
        ...
        filepath="/kaggle/working/efficientnetb0_continued_best.h5",
...
# SAVE FINAL MODEL
FINAL_MODEL_PATH = "/kaggle/working/efficientnetb0_final_continued.h5"
...
def plot_training_history(history):
    ...
    plt.suptitle(
        "EfficientNetB0 — Training History (DDR Dataset)",
        fontsize=15,
        fontweight="bold",
        y=1.01,
    )
